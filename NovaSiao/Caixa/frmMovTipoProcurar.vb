...
Public Class frmMovTipoProcurar
    ...
    '
    Property propIdMovTipo_Escolha As Integer
    Property propMovTipo_Escolha As String
    Property propMeio_Escolha As Byte
    '
...
#Region "LISTAGEM"
    ...
    Private Sub ObterTipo()
        ...
        '
        Try
            dtTipos = mBLL.MovTipo_GET_Dt
        Catch ex As Exception
            MessageBox.Show("Uma exceção ocorreu ao obter lista de Tipos de Movimentação" &
                            vbNewLine & ex.Message, "Exceção",
...
#Region "BUTTONS FUNCTION"
    ...
    Private Sub btnEscolher_Click(sender As Object, e As EventArgs) Handles btnEscolher.Click
        ...
        '
        ' DEFINIR O VALOR
        propIdMovTipo_Escolha = CInt(lstItens.SelectedItems(0).Text) ' ID DO TIPO
        propMovTipo_Escolha = lstItens.SelectedItems(0).SubItems(1).Text ' DESCRICAO DO TIPO
        propMeio_Escolha = lstItens.SelectedItems(0).SubItems(1).Value ' MEIO DO TIPO
        '
...
#Region "OUTRAS FUNCOES"
    ...
    Private Sub ProcurarST()
        ...
        If txtProcura.TextLength > 0 AndAlso IsNumeric(txtProcura.Text.Substring(0, 1)) Then
            dvTipos.RowFilter = "IDMovTipo = " & txtProcura.Text
        Else
            dvTipos.RowFilter = "MovTipo LIKE '*" & txtProcura.Text & "*'" ' PROCURA PELO NOME
        End If
        '
    End Sub
    '
