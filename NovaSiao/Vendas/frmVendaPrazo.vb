...
#Region "CARREGA OS COMBOBOX"
    ...
    Private Sub CarregaCmbVendaTipo()
        '
        Dim dtVTipo As New DataTable
        '--- Adiciona as Colunas
        dtVTipo.Columns.Add("idVTipo")
        dtVTipo.Columns.Add("VTipo")
        '--- Adiciona todas as possibilidades de Frete
        dtVTipo.Rows.Add(New Object() {0, "Varejo"})
        dtVTipo.Rows.Add(New Object() {1, "Atacado"})
        dtVTipo.Rows.Add(New Object() {2, "ECommerce"})
        dtVTipo.Rows.Add(New Object() {3, "Interna"}) '--- Venda para funcionarios da loja
        dtVTipo.Rows.Add(New Object() {4, "Especial"}) '--- Venda para proprietários, amigos e parentes deles
        '
        With cmbVendaTipo
            .DataSource = dtVTipo
            .ValueMember = "idVTipo"
            .DisplayMember = "VTipo"
            .DataBindings.Add("SelectedValue", bindVenda, "VendaTipo", True, DataSourceUpdateMode.OnPropertyChanged)
        End With
        '
    End Sub
    '
...
#Region "FINALIZAR VENDA"
    ...
    Private Function Verificar() As Boolean
        ...
        If IsNothing(_Venda.VendaTipo) Then
...
#Region "FUNCOES NECESSARIAS"
    ...
    Private Function AtualizaTotalGeral() As Double
        If _ItensList.Count > 0 Then
            Dim T As Double = 0
            '
            T = AtualizaTotalProdutos() + _Venda.ValorFrete + _Venda.ValorImpostos + _Venda.ValorAcrescimos
            '
    ...
    Private Sub ComboBox_SelectedValueChanged(sender As Object, e As EventArgs) _
        ...
        If Sit = FlagEstado.RegistroBloqueado AndAlso VerificaAlteracao = True Then
            ...
            Select Case cmb.Name
                Case "cmbVendaTipo"
                    VerificaAlteracao = False
                    cmbVendaTipo.SelectedValue = _Venda.VendaTipo
                    VerificaAlteracao = True
