...
#Region "OUTRAS FUNCOES"
    ...
    Private Sub txt_KeyDown(sender As Object, e As KeyEventArgs) Handles txtAutor.KeyDown,
    ...
    Private Function FindProduto(ByVal res As clReserva) As Boolean
        ...
        If IDProdutoTipo Is Nothing Then
            If (res.Produto.ToLower Like "*" & txtProduto.Text.ToLower & "*") AndAlso
                (res.ClienteNome.ToLower Like "*" & txtAutor.Text.ToLower & "*") Then
                Return True
            Else
                Return False
            End If
        Else
            If (res.Produto.ToLower Like "*" & txtProduto.Text.ToLower & "*") AndAlso
                (res.ClienteNome.ToLower Like "*" & txtAutor.Text.ToLower & "*") AndAlso
...
#Region "LISTAGEM"
    ...
    Private Sub FormataListagem()
        '
        clnRGProduto.DisplayMember = "IDReserva"
        clnRGProduto.Width = 70
        '
        clnPreco.DisplayMember = "ReservaData"
        clnPreco.Width = 80
        '
        clnEstoque.DisplayMember = "ClienteNome"
        clnEstoque.Width = 150
        '
        clnEstoqueMinimo.DisplayMember = "TelefoneA"
        clnEstoqueMinimo.Width = 110
        '
        clnEstoqueIdeal.DisplayMember = "TelefoneB"
        clnEstoqueIdeal.Width = 110
        '
